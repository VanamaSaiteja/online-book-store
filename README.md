...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/VanamaSaiteja/online-book-store.git```> Select master Branch > Next > Next > Finish.
